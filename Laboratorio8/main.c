...
{   //Se configura reloj a 40MHz
    ...
    while(1){
        //Dependiendo de la letra escrita se encendera un led
        if (state & state2){
            if (valor == 'r'){ //rojo
...
void UARTIntHandler(void){
    ...
    else if (valor == 'r'|valor == 'g'|valor == 'b'){   //Si no se esta apachando de nuevo un valor y el valor presionado es r,g o b, entonces se enciende state2
        state2 = true;
    }
